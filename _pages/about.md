...
Chinese Bio
======
中国科学院自动化研究所项目研究员、博士生导师。研究兴趣包括：计算机视觉、三维重建与AI4Science，具体研究内容包括：生物特征识别、数字人及仿生人、世界模型、AI+流体力学。入选国家级青年拔尖人才计划，国际模式识别协会（IAPR）生物特征识别青年学者奖（YBIA）获得者（两年一次，每次从全球范围内评选40岁以下学者一名）。共发表论文150余篇，发表文章的Google Scholar总引用次数为12000余次，入选IEEE Senior Member、CCF高级会员、CSIG高级会员、百度学术全球华人AI青年学者榜单（全球25人）。获得三次国际竞赛冠军以及四项最佳论文及提名奖。授权国家发明专利24项。任国际期刊T-IFS (CCF:A) 、Pattern Recognition (CCF:B) 、T-BIOM 编委 (Associate Editor)， 国际生物特征识别大会 IJCB 2025 程序主席 (Program Chair), 中国图象图形学学会(CSIG)青托俱乐部副主席，中国人工智能学会模式识别专委会(CAAI-PR)副秘书长。获中国图象图形学学会自然科学二等奖（第一完成人），中国电子学会科技进步二等奖。承担了国家自然科学基金重大项目（培育项目）、面上项目、中科院先导A专项课题、北京市联合项目以及华为、腾讯、阿里、商汤、Minimax、美的等校企合作项目，相关成果被PyTorch官方Twitter报道，开源代码在Github上收获8000余星。
